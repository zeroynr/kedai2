                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($mk['status_pembayaran'] === "Menunggu Pembayaran" || $mk['status_pembayaran'] === "Belum Bayar") { ?>
                                            ...
                                            <?php } elseif ($mk['status_pembayaran'] === "Hangus") { ?>
                                                <button class="btn btn-sm btn-secondary" disabled>Hangus</button>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php
